    ...
    public void init() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(SecondActivity.this, LineManagementActivity.class);
            ...
            public void click(Object obj, View view) {
                ...
                if (view.getId() == R.id.line_listview_item_img1) {
                    ...
                    if (Line_item_img1 == null) {
                        ...
                        intent.setClass(SecondActivity.this, PhotographLocationActivity.class);
                        intent.putExtra("imageFlag", imageFlag_1);
                        startActivityForResult(intent, 2);
                    } else {
                        Intent intent = new Intent();
                        intent.setClass(SecondActivity.this, LargeActivity.class);
...
//                }
    ...
    public void query_line_name() {
        dao = dao == null ? new ChannelDao(SecondActivity.this) : dao;
...
//                builder.setMessage("确定删除?");
                ...
                builder.setPositiveButton("新建文件夹", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // 2. 新建对话框对象
                        final Dialog dialog2 = new AlertDialog.Builder(SecondActivity.this).create();
...
//                                                provinces.setLine_name(number);
                ...
                builder.setNegativeButton("新建文件", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // 2. 新建对话框对象
                        final Dialog dialog1 = new AlertDialog.Builder(SecondActivity.this).create();
                                ...
                                try {
                                    if (e1 == null || e1.getText().toString().trim().length() == 0) {
                                        ...
                                        if (e1 != null || e1.getText().toString().trim().length() != 0) {
                                            ...
                                            if (isExistName == false) {
                                                Toast.makeText(SecondActivity.this, "此数据已存在，不能重复添加！", Toast.LENGTH_SHORT).show();
                                            } else {
                                                initDataImportant2();
